...
export const nodes = [
  {
    "id": "apc-antigen",
    "label": "peptide–MHC",
    "full": "Antigen-presenting cell displaying peptide on MHC",
  ...
  },
  {
    "id": "tcr-cd3",
    "label": "TCR–CD3",
    "full": "T cell receptor αβ heterodimer in complex with CD3γε/δε/ζζ",
  ...
  },
  {
    "id": "lck",
    "label": "Lck",
    "full": "Lymphocyte-specific protein tyrosine kinase",
    "compartment": "responder",
    "klass": "kinase",
    "pathways": [
      "tcr"
  ...
  },
  {
    "id": "cd28",
    "label": "CD28",
    "full": "CD28 costimulatory receptor",
    "compartment": "responder",
    "klass": "receptor",
    "pathways": [
      "tcr"
  ...
  {
    "id": "trail-fl",
    "label": "TRAIL (full length)",
    "full": "TNFSF10 — the trimerising parent ligand",
    "compartment": "extracellular",
    "klass": "cytokine",
    "pathways": [
      "tcr"
  ...
  },
  {
    "id": "trailshort",
    "label": "TRAILshort",
    "full": "TRAIL splice variant lacking cysteine 230 — dominant-negative, non-trimerising",
    "compartment": "extracellular",
    "klass": "cytokine",
    "pathways": [
      "tcr"
    ...
    "samhd1": "NO established SAMHD1 link. This arm is imported context for the T-cell attrition phenotype, not a consequence of A565T. Treat it as a candidate modifier to be tested, not as part of the variant cascade.",
    "refs": [
      "jalali2026"
    ],
    "evidence_tier": "L3_cell_line",
  ...
  },
  {
    "id": "dr5",
    "label": "DR5 (TRAIL-R2)",
    "full": "TNFRSF10B — death receptor 5",
    "compartment": "responder",
    "klass": "receptor",
    "pathways": [
      "tcr"
  ...
  },
  {
    "id": "shp1",
    "label": "SHP-1 (PTPN6)",
    "full": "Src homology region 2 domain–containing phosphatase 1",
    "compartment": "responder",
    "klass": "enzyme",
    "pathways": [
      "tcr"
  ...
  },
  {
    "id": "cd3z",
    "label": "CD3ζ",
    "full": "CD247 — the TCR ζ-chain carrying the ITAMs",
    "compartment": "responder",
    "klass": "adaptor",
    "pathways": [
      "tcr"
  ...
  },
  {
    "id": "zap70",
    "label": "ZAP-70",
    "full": "Zeta-chain-associated protein kinase 70",
    "compartment": "responder",
    "klass": "kinase",
    "pathways": [
      "tcr"
  ...
  },
  {
    "id": "lat",
    "label": "LAT",
    "full": "Linker for activation of T cells",
    "compartment": "responder",
    "klass": "adaptor",
    "pathways": [
      "tcr"
  ...
  },
  {
    "id": "cd69",
    "label": "CD69",
    "full": "Early T-cell activation marker",
    "compartment": "responder",
    "klass": "effector",
    "pathways": [
      "tcr"
  ...
  },
  {
    "id": "cd40l",
    "label": "CD40L",
    "full": "CD154 — T-cell help delivered to B cells and APCs",
    "compartment": "responder",
    "klass": "effector",
    "pathways": [
      "tcr"
  ...
  {
    "id": "tcell-prolif",
    "label": "clonal proliferation",
    "full": "Antigen-driven T-cell expansion",
    "compartment": "responder",
    "klass": "effector",
    "pathways": [
      "tcr"
  ...
  },
  {
    "id": "car-t",
    "label": "CD19 CAR-T",
    "full": "CD19-directed chimeric antigen receptor T cells",
    "compartment": "extracellular",
    "klass": "drug",
    "pathways": [
      "tcr",
  ...
  {
    "id": "anti-trailshort",
    "label": "anti-TRAILshort",
    "full": "TRAILshort-neutralising monoclonal antibody",
    "compartment": "extracellular",
    "klass": "drug",
    "pathways": [
      "tcr",
  ...
  },
  {
    "id": "nsc87877",
    "label": "NSC-87877",
    "full": "Small-molecule SHP-1 inhibitor",
    "compartment": "responder",
    "klass": "drug",
    "pathways": [
      "tcr",
...
export const edges = [
  ...
  },
  {
    ...
    "evidence": "G",
    "bend": 0.3,
    "detail": "The in vivo arm: TRAILshort-knockin promoted persistence of transformed MEFs and L428 lymphoma in humanised mice and antagonised CD19 CAR-T control, while the human association data span chronic viral infection, malignancy and autoimmunity.",
    "refs": [
      "jalali2026"
    ],
    "evidence_tier": "L3_cell_line",
