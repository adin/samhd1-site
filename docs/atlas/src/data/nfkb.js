...
export const nodes = [
  {
    "id": "tak1",
    "label": "TAK1 / TAB1-3",
    "full": "TGF-β-activated kinase 1 (MAP3K7) with its TAB adaptors",
    "compartment": "cytosol",
    "klass": "kinase",
    "pathways": [
      "nfkb"
  ...
  },
  {
    "id": "lubac",
    "label": "LUBAC",
    "full": "Linear ubiquitin chain assembly complex — HOIP / HOIL-1 / SHARPIN",
    "compartment": "cytosol",
    "klass": "enzyme",
    "pathways": [
      "nfkb",
  ...
  },
  {
    "id": "m1ub",
    "label": "M1-linear Ub",
    "full": "Met1-linked (linear) polyubiquitin",
    "compartment": "cytosol",
    "klass": "metabolite",
    "pathways": [
      "nfkb"
  ...
  },
  {
    "id": "a20",
    "label": "A20 / TNFAIP3",
    "full": "Tumour necrosis factor alpha-induced protein 3",
    "compartment": "cytosol",
    "klass": "effector",
    "pathways": [
      "nfkb"
  ...
  },
  {
    "id": "cyld",
    "label": "CYLD",
    "full": "Cylindromatosis lysine 63 deubiquitinase",
    "compartment": "cytosol",
    "klass": "effector",
    "pathways": [
      "nfkb"
  ...
  },
  {
    "id": "otulin",
    "label": "OTULIN",
    "full": "OTU deubiquitinase with linear linkage specificity",
    "compartment": "cytosol",
    "klass": "effector",
    "pathways": [
      "nfkb"
  ...
  },
  {
    "id": "nik",
    "label": "NIK",
    "full": "NF-κB-inducing kinase (MAP3K14)",
    "compartment": "cytosol",
    "klass": "kinase",
    "pathways": [
      "nfkb"
  ...
  },
  {
    "id": "ikka",
    "label": "IKKα",
    "full": "Inhibitor of κB kinase alpha (CHUK) — the non-canonical catalytic subunit",
    "compartment": "cytosol",
    "klass": "kinase",
    "pathways": [
      "nfkb"
  ...
  },
  {
    "id": "relb",
    "label": "p52 : RelB",
    "full": "Non-canonical NF-κB heterodimer",
    "compartment": "nucleus",
    "klass": "tf",
    "pathways": [
      "nfkb"
  ...
  },
  {
    "id": "baff",
    "label": "BAFF",
    "full": "B-cell activating factor (TNFSF13B)",
  ...
  {
    "id": "nfkb-targets",
    "label": "NF-κB target set",
    "full": "κB-element gene set — NLRP3, IL1B, IL18, IL6, IL23A, TNF, CXCL8, NFKBIA, TNFAIP3",
    "compartment": "nucleus",
    "klass": "complex",
    "pathways": [
      "nfkb",
    ...
    "samhd1": "SAMHD1 suppresses the NF-κB pathway directly, so haploinsufficiency raises the resting level of every gene on this list at once. That is Brake 4 — and it is why Loop B and the Th17 arm are elevated at baseline rather than only after a trigger.",
    "refs": [
      "wang2018",
      "swanson2019"
    ],
  ...
  },
  {
    "id": "proil18",
    "label": "pro-IL-18",
    "full": "Inactive interleukin-18 precursor",
    "compartment": "cytosol",
    "klass": "cytokine",
    "pathways": [
      "inflammasome",
  ...
  },
  {
    "id": "cxcl8",
    "label": "CXCL8 / IL-8",
    "full": "Interleukin-8 — neutrophil chemoattractant",
    "compartment": "extracellular",
    "klass": "cytokine",
    "pathways": [
      "nfkb"
...
export const edges = [
  ...
  },
  {
    ...
    "to": "nfkb-targets",
    "kind": "inhibit",
    "label": "BRAKE 4 — suppression here lowers the entire priming layer at once",
    "pathways": [
      "samhd1",
      "nfkb"
    ],
