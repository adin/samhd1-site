...
export const REFS = {
  ...
  meng2026:       { text: 'Meng X, Zhou Q, Zhu Z, Qiao W, Geng B. Modeling calcific aortic valve disease with engineered human valve tissues identifies SAMHD1 as a therapeutic target. Biomaterials 2026;308:124432.', doi: '10.1016/j.biomaterials.2026.124432' },
  thomsen2026:    { text: 'Thomsen EA, Zhao J, Narita R, Davis LJ, Olagnier D. A genome-wide map of the genetic network in monocytes that regulates type I interferon induction by the cGAS-STING pathway. Sci Signal 2026;19(898):eadx3808.', doi: '10.1126/scisignal.adx3808' },
  plazag2026:     { text: 'Plaza-G AI, Miguez-Amil S, Hayes AM, Ciesielski GL, Feinstein P. Structural and single-molecule insights into the core human mitochondrial DNA replisome. Biochem J 2026;483(15):BCJ20260373.', doi: '10.1042/BCJ20260373' },
  zhang2026ra:    { text: 'Zhang R, Song Z, Xin Q, Xing W, Zhang W. The mitochondrial DNA signal in rheumatoid arthritis: From metabolic victim to inflammatory driver. Biochem Biophys Res Commun 2026;710:154304.', doi: '10.1016/j.bbrc.2026.154304' },
  cobb2026:       { text: 'Cobb L, Kumar J, Roy A, Walsh S, Sheerin U-M. Case of Aicardi-Goutières syndrome diagnosed in adulthood on whole-genome sequencing. BMJ Neurol Open 2026;8(1):e001407.', doi: '10.1136/bmjno-2025-001407' },
  mohanty2026:    { text: 'Mohanty S, Suklabaidya S, Mnatsakanyan N, Jacobson S, Harhaj EW. HTLV-1 Tax induces PINK1-PRKN/parkin-dependent mitophagy to mitigate activation of the CGAS-STING1 pathway. Autophagy 2026;22(7):1–18.', doi: '10.1080/15548627.2026.2707897' },
