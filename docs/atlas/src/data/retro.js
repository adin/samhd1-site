...
export const nodes = [
  {
    "id": "l1-locus",
    "label": "LINE-1 locus",
    "full": "Long interspersed nuclear element 1 (L1HS) — the only autonomous human retrotransposon",
    "compartment": "nucleus",
    "klass": "retro",
    "pathways": [
      "retro",
  ...
  },
  {
    "id": "alu-locus",
    "label": "Alu / SINE loci",
    "full": "Alu short interspersed nuclear elements",
    "compartment": "nucleus",
    "klass": "retro",
    "pathways": [
      "retro",
  ...
  },
  {
    "id": "herv-locus",
    "label": "HERV loci",
    "full": "Human endogenous retroviruses — LTR retroelements",
    "compartment": "nucleus",
    "klass": "retro",
    "pathways": [
      "retro"
  ...
  },
  {
    "id": "l1-mrna",
    "label": "L1 mRNA",
    "full": "Bicistronic L1 transcript (ORF1 + ORF2)",
    "compartment": "nucleus",
    "klass": "ligand",
    "pathways": [
      "retro"
  ...
  },
  {
    "id": "orf1p",
    "label": "ORF1p",
    "full": "L1 ORF1 protein — trimeric nucleic-acid chaperone",
    "compartment": "granule",
    "klass": "retro",
    "pathways": [
      "retro"
  ...
  },
  {
    "id": "orf2p",
    "label": "ORF2p",
    "full": "L1 ORF2 protein — endonuclease + reverse transcriptase",
    "compartment": "cytosol",
    "klass": "retro",
    "pathways": [
      "retro",
    ...
    "samhd1": "SAMHD1 restricts L1 by two routes at once: it starves ORF2p reverse transcriptase of dNTPs, and it promotes stress-granule formation that sequesters the L1 ribonucleoprotein. Both routes are lost together in haploinsufficiency — and the dNTP route is lost in the WRONG direction, because the pool goes UP by 40–60%.",
    "refs": [
      "zhao2013samhd1",
      "hu2015samhd1",
      "herrmann2018"
  ...
  },
  {
    "id": "l1-rnp",
    "label": "L1 RNP",
    "full": "L1 ribonucleoprotein particle (L1 RNA + ORF1p + ORF2p)",
    "compartment": "granule",
    "klass": "retro",
    "pathways": [
      "retro"
    ...
    "samhd1": "SAMHD1 promotes stress-granule formation that traps L1 RNPs out of circulation. This is a physical, non-enzymatic restriction mechanism — and it is regulated by SAMHD1 T592 phosphorylation, meaning the same phospho-switch that governs genome stability also governs retroelement restriction.",
    "refs": [
      "hu2015samhd1",
      "herrmann2018"
    ],
  ...
  },
  {
    "id": "tprt",
    "label": "TPRT",
    "full": "Target-primed reverse transcription",
    "compartment": "nucleus",
    "klass": "retro",
    "pathways": [
      "retro",
  ...
  {
    "id": "l1-insertion",
    "label": "new L1 insertion",
    "full": "De novo retrotransposition event",
    "compartment": "nucleus",
    "klass": "retro",
    "pathways": [
      "retro",
    ...
    "samhd1": "Elevated dNTP pools support L1 reverse transcription, so retroelement mutagenic burden is one of the three pressures in the genomic-instability block alongside replication-error load and impaired homologous recombination.",
    "refs": [
      "docConcept",
      "zhao2013samhd1"
    ],
  ...
  },
  {
    "id": "l1-cdna",
    "label": "L1 cDNA",
    "full": "Cytosolic L1 reverse-transcription product (ssDNA / RNA:DNA hybrid)",
    "compartment": "cytosol",
    "klass": "ligand",
    "pathways": [
      "retro",
  ...
  {
    "id": "alu-dsrna",
    "label": "Alu inverted-repeat dsRNA",
    "full": "Duplex RNA formed by inverted Alu pairs in 3′UTRs",
    "compartment": "cytosol",
    "klass": "ligand",
    "pathways": [
      "retro",
  ...
  {
    "id": "herv-rna",
    "label": "HERV transcripts",
    "full": "Endogenous retroviral RNA and Env protein",
    "compartment": "cytosol",
    "klass": "ligand",
    "pathways": [
      "retro",
  ...
  },
  {
    "id": "hush",
    "label": "HUSH complex",
    "full": "Human silencing hub — TASOR + MPP8 + PPHLN1",
    "compartment": "nucleus",
    "klass": "restrict",
    "pathways": [
      "retro"
  ...
  },
  {
    "id": "morc2",
    "label": "MORC2",
    "full": "MORC family CW-type zinc finger 2 — ATP-dependent chromatin compactor",
    "compartment": "nucleus",
    "klass": "restrict",
    "pathways": [
      "retro"
  ...
  },
  {
    "id": "setdb1",
    "label": "SETDB1",
    "full": "SET domain bifurcated histone lysine methyltransferase 1",
    "compartment": "nucleus",
    "klass": "restrict",
    "pathways": [
      "retro"
  ...
  },
  {
    "id": "h3k9me3",
    "label": "H3K9me3",
    "full": "Trimethylated histone H3 lysine 9 — the repressive mark",
    "compartment": "nucleus",
    "klass": "structure",
    "pathways": [
      "retro"
  ...
  },
  {
    "id": "dnmt1",
    "label": "DNMT1 / UHRF1",
    "full": "Maintenance DNA methyltransferase and its targeting partner",
    "compartment": "nucleus",
    "klass": "restrict",
    "pathways": [
      "retro"
  ...
  },
  {
    "id": "trim28",
    "label": "TRIM28 / KAP1",
    "full": "Tripartite motif 28 with KRAB zinc-finger proteins",
    "compartment": "nucleus",
    "klass": "restrict",
    "pathways": [
      "retro"
  ...
  },
  {
    "id": "zap",
    "label": "ZAP / ZC3HAV1",
    "full": "Zinc-finger antiviral protein",
    "compartment": "cytosol",
    "klass": "restrict",
    "pathways": [
      "retro"
  ...
  },
  {
    "id": "mov10",
    "label": "MOV10",
    "full": "Moloney leukaemia virus 10 — RNA helicase",
    "compartment": "granule",
    "klass": "restrict",
    "pathways": [
      "retro"
  ...
  },
  {
    "id": "oas",
    "label": "OAS1-3",
    "full": "2′-5′-oligoadenylate synthetases",
    "compartment": "cytosol",
    "klass": "effector",
    "pathways": [
      "isg",
  ...
  },
  {
    "id": "adar1",
    "label": "ADAR1 p150",
    "full": "Adenosine deaminase acting on RNA 1, interferon-inducible isoform",
    "compartment": "cytosol",
    "klass": "restrict",
    "pathways": [
      "retro",
  ...
  },
  {
    "id": "apobec3",
    "label": "APOBEC3A/B",
    "full": "Apolipoprotein B mRNA editing enzyme catalytic subunits 3A/3B",
    "compartment": "cytosol",
    "klass": "restrict",
    "pathways": [
      "retro",
  ...
  },
  {
    "id": "trex1",
    "label": "TREX1",
    "full": "Three-prime repair exonuclease 1 (DNase III) — AGS1",
    "compartment": "cytosol",
    "klass": "restrict",
    "pathways": [
      "retro",
  ...
  {
    "id": "rnaseh2",
    "label": "RNase H2 (A/B/C)",
    "full": "Ribonuclease H2 heterotrimer — AGS2, AGS3, AGS4",
    "compartment": "nucleus",
    "klass": "restrict",
    "pathways": [
      "retro",
  ...
  {
    "id": "ags-family",
    "label": "AGS gene family",
    "full": "Aicardi-Goutières syndrome loci AGS1–AGS8",
    "compartment": "nucleus",
    "klass": "complex",
    "pathways": [
      "retro"
    ...
    "samhd1": "The heterozygous phenotype is the attenuated version: survival-compatible, adult-onset, moderate-amplitude, chronic rather than catastrophic — what the concept note names NACI.",
    "refs": [
      "rice2009",
      "crow2006trex1",
      "crow2006rnaseh2",
  ...
  },
  {
    "id": "micronucleus",
    "label": "micronuclei",
    "full": "Micronuclei from mis-segregated or damaged chromatin",
    "compartment": "nucleus",
    "klass": "ligand",
    "pathways": [
      "genome",
...
export const edges = [
  ...
  },
  {
    ...
    "to": "dsb",
    "kind": "produce",
    "label": "every insertion attempt starts with a deliberate nick",
    "pathways": [
      "genome",
      "retro"
    ],
  ...
  },
  {
    ...
    "to": "ssdna",
    "kind": "degrade",
    "label": "clears cytosolic ssDNA generally",
    "pathways": [
      "retro",
      "genome"
    ],
  ...
  },
  {
    ...
    "to": "rloop",
    "kind": "degrade",
    "label": "resolves RNA:DNA hybrids",
    "pathways": [
      "retro",
      "genome"
    ],
  ...
  },
  {
    ...
    "to": "orf2p",
    "kind": "inhibit",
    "label": "dNTP starvation of the L1 reverse transcriptase",
    "pathways": [
      "retro",
      "samhd1"
    ],
  ...
  },
  {
    ...
    "to": "l1-rnp",
    "kind": "inhibit",
    "label": "promotes stress-granule sequestration of the RNP",
    "pathways": [
      "retro",
      "samhd1"
    ],
  ...
  },
  {
    ...
    "to": "dsrna-cyt",
    "kind": "inhibit",
    "label": "sequesters immunostimulatory dsRNA in LLPS condensates",
    "pathways": [
      "retro",
      "samhd1",
      "rlr-mavs"
  ...
  },
  {
    ...
    "to": "orf2p",
    "kind": "activate",
    "label": "elevated dNTPs FUEL reverse transcription — restriction fails in the wrong direction",
    "pathways": [
      "retro",
      "samhd1"
    ],
  ...
  },
  {
    ...
    "to": "samhd1",
    "kind": "produce",
    "label": "SAMHD1 is an ISG — the pathway tries to fix itself and cannot",
    "pathways": [
      "isg",
      "samhd1"
    ],
